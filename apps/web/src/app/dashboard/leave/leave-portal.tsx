...
export function LeavePortal() {
    ...
    const [savingSuggestion, setSavingSuggestion] = useState<string | null>(
        null,
    );
    ...
    async function applySuggestion(suggestion: PortalLeaveSuggestion) {
        ...
        try {
            ...
            setSubmitError(
                "Could not apply the suggestion. The form was not changed.",
            );
        } finally {
    ...
    const balanceByType = new Map(
        me.balances.map((b) => [b.leaveType, b.balance]),
    );
        ...
        <div className="space-y-8">
            ...
            {suggestions.length > 0 ? (
                ...
                >
                    ...
                    <p className="text-xs text-muted-foreground">
                        A suggestion only fills the form below it never submits
                        anything.
                    </p>
                </section>
            ) : null}
